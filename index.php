...
<div class="fixed-action-btn">
  <a class="btn-floating btn" href="#homepage">
    ^
  </a>
</div>
...
<div class="line-title"><h4 class="title center">let me introduce my self!</h4><hr class="line-title"></div>

<div class="row konten-web" id="kontenweb">
	<div class="col m6 s12" id="about">		<!-- section about -->			
	...
	<div class="col m6 s12">
		<div class="row" id="skill">			<!-- section skill -->
...
<div class="portfolio center" id="portfolio">
	...
	<footer class="page-footer grey darken-4">
		  <div class="row row-footer">
			...
			<div class="col m4 menu-footer center">
				<ul>
					<h5>Menu</h5><br>
					<li><a href="#about">Who Am I</a></li>
					<li><a href="#skill">Skill</a></li>
			...
			<br><br><br>&copy; 2018 Portfolio | Ilham Nur Agustian
			</div>		   
		  </div>  <!-- ./row  -->
	</footer>
